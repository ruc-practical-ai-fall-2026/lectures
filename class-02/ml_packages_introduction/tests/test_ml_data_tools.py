...
def test_make_train_test_split_records_selected_rows_and_returns_arrays(monkeypatch) -> None:
    ...
    x_train, x_test, y_train, y_test = ml_data_tools.make_train_test_split_dataframes(
        input_df,
    ...
    np.testing.assert_array_equal(input_df["test flag"], np.array([0.0, 1.0, 0.0, 1.0, 0.0]))


def test_make_train_test_split_with_no_test_rows_returns_empty_test_arrays() -> None:
